const config = {
    ...
    newPlaceSelector: '.popup_new-place',
    editProfileSelector: '.popup_edit',
    fullscreenCardSelector: '.popup_foolscreen-card',
    ...
    gridZonaSelector: '.grid-zona',
    btnAddNewPlaceSelector: '.profile__add',
    btnEditProfileSelector: '.profile__edit',
    fullNameSelector: '.profile__name',
    aboutSelector: '.profile__about',
    popupNameSelector: '.popup__name',
    linkNewPlaceSelector: '.popup__link',
    popupAboutSelector: '.popup__about',
    fullscreenImageSelector: '.popup__card-image',
    fullscreenTitleSelector: '.popup__card-title',
    templateClass: '.template',
    btnCloseClass: 'popup__close'
};
